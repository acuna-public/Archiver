  ...
  */
  ...
  public class Archiver {
    ...
    public static void pack (String input, String output) throws CompressException {
      pack (new File (input), output);
    }
    ...
    public static void pack (String input, File output) throws CompressException {
      pack (new File (input), output);
    }
    ...
    public static InputStream unpack (URL url, String userAgent) throws DecompressException {
      return unpack (url, userAgent, Net.defTimeout);
    }
